...
namespace AutoSteamApp.Core
{
    public static class Settings
    {
        ...
        public static string SupportedGameVersion = "421810"; // update 15.23.00

        public static ulong Off_Base = 0x140000000;
        public static ulong Off_SteamworksCombo = 0x4F87C30; // update 15.23.00

        public static ulong Off_SaveData = 0x5013950; //update 15.23.00
